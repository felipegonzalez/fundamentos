...
**Observación**: Hay varias maneras de definir los cuantiles  
con precisión (ver [@cleveland93]): 
...
En la práctica, es más conveniente usar $f_i= \frac{i - 0.5}{N}$,
...
**Escogiendo de los parámetros.** El paráemtro de suavizamiento se
...
En lugar de usar ajustes locales lineales, podemos usar ajustes locales cuadráticos
que nos permite capturar formas locales cuadráticas sin tener que suavizar demasiado
poco:
...
$w_n(x)$, es decir, minimizamos (en el caso lineal):
